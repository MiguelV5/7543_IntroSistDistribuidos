...
class HandshakeHeaderRDT():
    ...
    def __init__(self, transfer_type: TransferType, protocol: Protocol, file_name: str, file_size, sha1_hash):
    ...
    def as_bytes(self):
        return struct.pack(self.PACKET_FORMAT, self.transfer_type, self.protocol, self.file_name.encode('utf-8'), self.file_size, self.sha1_hash.encode('utf-8'))

    @classmethod
    def from_bytes(cls, data):
        transfer_type, protocol, file_name, file_size, sha1_hash = struct.unpack(
